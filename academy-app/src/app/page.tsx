            ...
            <div className="flex min-w-0 flex-col justify-center">
              ...
              <Reveal delay={0.15}>
                <div className="mt-8 flex flex-wrap items-center gap-3">
                  <Link href="/curriculum" className="ac-btn ac-btn-primary">
                    Kostenlos starten <ArrowRight width={16} height={16} />
                  </Link>
                  <Link href="/pricing" className="ac-btn ac-btn-ghost">
                    Preise ansehen
                  </Link>
                </div>
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 sm:py-24">
          <Reveal>
            ...
            <div className="mt-3 flex flex-wrap items-end justify-between gap-4">
              ...
              <Link href="/curriculum" className="ac-btn ac-btn-ghost !py-2.5 !px-4 !text-[13px]">
          ...
          <div className="mt-10 grid gap-5 sm:mt-14 lg:grid-cols-3">
            {levels.map((lvl, i) => (
              <Reveal key={lvl.id} delay={i * 0.06}>
                <Link href="/curriculum" className="ac-card ac-card-hover block h-full overflow-hidden">
      ...
      <section className="border-t" style={{ borderColor: "var(--ac-border)" }}>
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 sm:py-24">
          <div className="grid items-center gap-12 lg:grid-cols-[0.9fr_1.1fr]">
            {/* Portrait card — drop /public/monther.jpg in to replace the monogram. */}
            <Reveal className="order-2 lg:order-1">
              <div className="mx-auto w-full max-w-sm rotate-[1.5deg]">
                <div className="ac-card overflow-hidden p-4" style={{ boxShadow: "var(--ac-shadow)" }}>
                  <div
                    className="ac-dot-bg grid aspect-[4/5] w-full place-items-center rounded-lg"
                    style={{ background: "var(--ac-surface-2)" }}
                  >
                    <span
                      className="text-7xl font-extrabold"
                      style={{ fontFamily: "var(--font-syne)", color: "var(--ac-primary)" }}
                    >
                      MM
                    </span>
                  </div>
                  <div className="flex items-center justify-between px-1 pt-4">
                    <div>
                      <p className="font-semibold" style={{ fontFamily: "var(--font-syne)" }}>Monther Madkour</p>
                      <p className="text-xs" style={{ color: "var(--ac-ink-3)" }}>Gründer · MadkourMedia, Zürich</p>
                    </div>
                    <span className="ac-sticker !rotate-[3deg] !text-[10px]">dreht Level 1</span>
                  </div>
                </div>
              </div>
            </Reveal>
            ...
            <div className="order-1 lg:order-2">
              <Reveal>
                <span className="ac-eyebrow">Der Mensch dahinter</span>
                <h2 className="ac-h2 mt-3 max-w-xl">Du lernst mit mir – nicht mit einem Avatar.</h2>
              </Reveal>
              <Reveal delay={0.06}>
                <p className="mt-5 max-w-xl text-base leading-relaxed sm:text-lg" style={{ color: "var(--ac-ink-2)" }}>
                  Ich bin Monther. Mit meiner Agentur setze ich KI jeden Tag in echten
                  Kundenprojekten ein – Angebote, Content, Automationen. Genau das zeige ich
                  dir in den Lektionen: am Bildschirm, mit echten Tools, echten Beispielen und
                  auch den Momenten, in denen die KI danebenliegt.
                </p>
              </Reveal>
              <Reveal delay={0.1}>
                <ul className="mt-7 max-w-xl space-y-3">
                  {[
                    "Jedes Video selbst gedreht – kein KI-Avatar, kein Teleprompter-Roboter.",
                    "Alles, was ich zeige, benutze ich selbst im Agentur-Alltag.",
                    "Im Community-Forum und im Live Q&A antworte ich persönlich.",
                  ].map((t) => (
                    <li key={t} className="flex gap-2.5 text-sm leading-relaxed sm:text-base" style={{ color: "var(--ac-ink-2)" }}>
                      <Check width={18} height={18} style={{ color: "var(--ac-primary)", flexShrink: 0, marginTop: 2 }} />
                      {t}
                    </li>
                  ))}
                </ul>
              ...
              <Reveal delay={0.14}>
                <p className="mt-7 text-sm italic" style={{ color: "var(--ac-ink-3)" }}>
                  „Wenn ein Kurs über KI komplett von KI produziert ist – warum solltest du ihm
                  vertrauen?“
                </p>
              </Reveal>
            </div>
            ...
            >
              ...
              <div className="relative z-10 max-w-2xl">
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  <Link href="/lessons/was-ist-ki" className="ac-btn" style={{ background: "var(--ac-primary)", color: "#fff" }}>
