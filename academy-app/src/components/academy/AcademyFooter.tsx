...
const groups = [
  {
    ...
    links: [
      ...
      { href: "/prompts", label: "Prompt-Bibliothek" },
      { href: "/tools", label: "AI-Tool-Bibliothek" },
  ...
  },
  {
    title: "Plattform",
    links: [
      { href: "/pricing", label: "Preise & Abos" },
      { href: "/community", label: "Community" },
      { href: "/#levels", label: "Levels" },
      { href: "https://www.madkourmedia.com", label: "MadkourMedia" },
    ],
  },
]
