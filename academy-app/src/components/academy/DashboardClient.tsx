            ...
            <Reveal>
              <div className="ac-card overflow-hidden">
                <div className="flex flex-col gap-5 p-6 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <Link href={`/lessons/${cont.slug}`} className="ac-btn ac-btn-primary">
          ...
          {allDone && (
            <Reveal>
              <div className="ac-card p-6 text-center">
                ...
                <Link href="/certificates" className="ac-btn ac-btn-primary mt-4">
        ...
        <div className="space-y-6">
          ...
          <Reveal>
            <div className="ac-card p-6">
              ...
              <Link href="/certificates" className="mt-3 inline-flex items-center gap-1 text-sm" style={{ color: "var(--ac-primary)" }}>
