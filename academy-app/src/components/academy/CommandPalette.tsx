...
const pages: { title: string; href: string; hint: string }[] = [
  { title: "Dashboard", href: "/dashboard", hint: "Fortschritt, XP & Badges" },
  { title: "Lehrplan", href: "/curriculum", hint: "Alle Level & Lektionen" },
  { title: "Prompt-Bibliothek", href: "/prompts", hint: "Kopierfertige Prompts" },
  { title: "AI-Tools", href: "/tools", hint: "Tool-Vergleich & Empfehlungen" },
  { title: "Community", href: "/community", hint: "Fragen & Austausch" },
  { title: "Zertifikate", href: "/certificates", hint: "Deine Abschlüsse" },
  { title: "Preise", href: "/pricing", hint: "Free bis Elite" },
]
