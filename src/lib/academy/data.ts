...
export const lessons: Lesson[] = [
  ...
  },
  {
    ...
    resources: [r("res-11", "Checkliste: Der Delegations-Check", "checklist", "0.2 MB")],
  },
  {
  ...
  },
  {
    ...
    resources: [r("res-12", "Vorlage: Recherche-Auftrag", "template", "0.2 MB")],
  },
  {
    ...
    resources: [
      r("res-13", "Vorlage: Angebots-Generator", "template", "0.3 MB"),
      r("res-14", "Checkliste: Angebot vor dem Versand", "checklist", "0.2 MB"),
    ],
  },
  {
    id: "workflow-design",
    ...
    resources: [r("res-15", "Vorlage: Workflow-Canvas", "template", "0.3 MB")],
  },
  {
    ...
    resources: [r("res-16", "Vorlage: Kontext-Paket (Markdown)", "template", "0.2 MB")],
  },
  {
    id: "erster-ki-agent",
  ...
  },
  {
    ...
    resources: [r("res-17", "Cheatsheet: Context Engineering", "cheatsheet", "0.4 MB")],
  },
]
