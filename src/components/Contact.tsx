        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-20">
          ...
          <div className="md:col-span-5">
            <FadeIn>
              ...
              <h2
                className="font-display font-bold text-ink leading-[0.96] mb-8"
              ...
              >
                ...
                Ihr nächstes
                <br />
                <span className="text-accent">Projekt.</span>
              </h2>
            </FadeIn>
            <FadeIn delay={0.1}>
                ...
                <div className="flex items-center gap-3">
                  <span className="w-8 h-8 border border-white/[0.08] flex items-center justify-center flex-shrink-0">
                    <svg width="10" height="12" viewBox="0 0 10 12" fill="none">
                      <path d="M5 0C2.8 0 1 1.8 1 4C1 7 5 12 5 12C5 12 9 7 9 4C9 1.8 7.2 0 5 0ZM5 5.5C4.17 5.5 3.5 4.83 3.5 4C3.5 3.17 4.17 2.5 5 2.5C5.83 2.5 6.5 3.17 6.5 4C6.5 4.83 5.83 5.5 5 5.5Z" fill="#5C5C5C" />
                    </svg>
                  </span>
                ...
                <div className="flex flex-col items-start gap-4 py-16">
                  <div className="w-10 h-10 border border-accent/30 flex items-center justify-center">
                    <svg width="16" height="12" viewBox="0 0 16 12" fill="none">
                      <path d="M1 6L6 11L15 1" stroke="#6DBB7D" strokeWidth="1.5" strokeLinecap="round" />
                    </svg>
                  </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-8">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="flex flex-col gap-2">
                      <label className="label text-ink-3">Vorname</label>
                      <input
                        type="text"
                        placeholder="Max"
                        className="input"
                    ...
                    <div className="flex flex-col gap-2">
                      <label className="label text-ink-3">Nachname</label>
                      <input
                        type="text"
                  ...
                  {/* Email */}
                  <div className="flex flex-col gap-2">
                    <label className="label text-ink-3">E-Mail <span className="text-accent">*</span></label>
                    <input
                      type="email"
                        ...
                        <button
                          ...
                          className={`label px-4 py-2 border transition-all duration-200 ${
                            selected === s
                              ...
                              : "border-white/[0.10] text-ink-3 hover:border-white/20"
                          }`}
                        >
                          {s}
                        </button>
                  ...
                  {/* Message */}
                  <div className="flex flex-col gap-2">
                    <label className="label text-ink-3">Ihre Nachricht</label>
                    <textarea
                      rows={4}
