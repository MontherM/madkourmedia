...
const services = [
  {
    ...
    desc: "Von der Grundstucksanalyse bis zur schlusselfertigen Ubergabe: Wir entwickeln Immobilienprojekte mit klarem wirtschaftlichem Fokus und architektonischem Anspruch.",
    tags: ["Machbarkeit", "Konzept", "Planung"],
  },
  {
    num: "02",
    name: "Immobilienberatung",
    desc: "Strategische Beratung fur Investoren und Eigenturmer. Wir schaffen Klarheit, bevor Entscheidungen fallen.",
    tags: ["Strategie", "Bewertung", "Investoren"],
  },
  {
    num: "03",
    name: "Standort- & Potenzialanalyse",
    desc: "Fundierte Analyse von Lagen, Marktumfeldern und Entwicklungspotenzialen. Datenbasiert, erfahrungsgesattigt.",
    tags: ["Marktanalyse", "Due Diligence", "Standort"],
  },
  {
    num: "04",
    name: "Architektur- & Konzeptentwicklung",
    desc: "Wir denken Architektur und Wirtschaftlichkeit zusammen. Nutzungskonzepte, die uberzeugen und rentieren.",
    tags: ["Nutzungskonzept", "Planung", "Asthetik"],
  },
  {
    num: "05",
    name: "Baumanagement & Projektsteuerung",
    desc: "Termine, Kosten, Qualitat: Wir ubernehmen die Steuerung komplexer Bauprojekte mit voller Verantwortung.",
    tags: ["Termin", "Kosten", "Qualitat"],
  },
  {
    num: "06",
    name: "Vermarktungsunterstutzung",
    desc: "Positionierung, Visualisierung und Vermarktungsstrategie fur anspruchsvolle Immobilienprojekte.",
    tags: ["Marketing", "Visualisierung", "Vertrieb"],
  },
]
